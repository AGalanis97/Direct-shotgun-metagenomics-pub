...
Results: Except that the nest function doesn't seems to work with a lot of data (NEED TO BE FIX), I managed to extract a p-value for each GO across the 5 species found specifically in automn.
...
ONCE we fix the nesting issue, The GO appear to be significant will somehow require some level organisation (visulisation with ruban?, enrichment within highter level?... need to ask for advise to Pavlopoulos and Martin).
...
# Extract the maximum number (or Frequency) per GO
