...
# This script will reproduce Figures 2 A, B, C, and D as well as the RMSE calculation table
...
# In the read.csv function we make use of the file.path to determine where the files are located. Otherwise read.csv is trying to read from the 
# top level directory.
